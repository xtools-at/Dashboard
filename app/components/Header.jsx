        ...
        <header className="navbar-fixed">
         	<nav>
			    <div className="nav-wrapper">
		      	<a href="#/" className="brand-logo"><i className="material-icons">bubble_chart</i>xTools Dash</a>
            ...
            <a className="nav-back left hide hide-on-large-only" onClick={()=>{window.history.go(-1)}}><i className="material-icons">keyboard_arrow_left</i><span className="sr-only">Go Back</span></a>
			  		<ul className="right">
			        	<li><a className="waves-effect" title="Fork on Github" href="https://github.com/xtools-at/Dashboard" target="_blank">
                ...
                <li><a className="waves-effect" href="https://github.com/xtools-at/Dashboard" target="_blank"><i className="material-icons">code</i>Fork on Github</a></li>
              </ul>
			    </div>
		  	</nav>
      </header>
